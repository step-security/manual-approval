...
[![ci](https://github.com/step-security/manual-approval/actions/workflows/ci.yaml/badge.svg)](https://github.com/step-security/manual-approval/actions/workflows/ci.yaml)
...
```yaml
steps:
  - uses: step-security/manual-approval@v1
    with:
      secret: ${{ github.TOKEN }}
